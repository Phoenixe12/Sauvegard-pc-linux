public class Complexe {
    ...
    public int getPartieReelle() { return partieReelle; }

    public void setPartieReelle(int partieReelle) { this.partieReelle = partieReelle; }

    public int getPartieImaginaire() { return partieImaginaire; }

    public void setPartieImaginaire(int partieImaginaire) { this.partieImaginaire = partieImaginaire; }
