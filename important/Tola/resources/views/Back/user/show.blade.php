                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" id="name" placeholder="Enter your name"
                                             name="name" :value="old('name')" required autofocus autocomplete="name" / value="{{$user-> name}}"disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label" for="email">Email or Username</label>
                                        <div class="form-control-wrap">
                                            <input type="email" class="form-control form-control-lg" id="email" placeholder="Enter your email address or username" name="email" :value="old('email')" required / value="{{$user-> email}}"disabled="disabled">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg" id="password" placeholder="Enter your passcode" type="password" name="password" required autocomplete="new-password" / value="{{$user-> password}}"disabled="disabled">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input type="password" class="form-control form-control-lg" placeholder="Enter your passcode" id="password_confirmation" name="password_confirmation" required autocomplete="new-password" / value="{{$user-> password}}"disabled="disabled">
                                        </div>
                                    </div>
